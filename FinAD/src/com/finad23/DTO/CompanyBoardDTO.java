...
public class CompanyBoardDTO {
	...
	private String title, companyName, companyInfo1, companyInfo2, companyInfo3; //?†úÎ™?, ÎßàÏ??åÖ ?ã¥?ãπ?ûê ?†ïÎ≥?
	private String recruitmentDate1, recruitmentDate2, promotionDate1, promotionDate2; //Î™®Ïßë Í∏∞Í∞Ñ, Í¥ëÍ≥†Í∏∞Í∞Ñ
	private String recruitmentNum, avgViewers, subscribers, sex; //Î™®Ïßë?ù∏?õê, ?èâÍ∑? ?ãúÏ≤??ûê , ÏµúÏÜå Íµ¨ÎèÖ?ûê?àò
	private Boolean underachiever; //ÎØ∏Îã¨?ûê Ïß??õê
	private int promotionMoney; //Ï¥? Í¥ëÍ≥† ÏßÑÌñâÎπ?
	private String promotionType, previousPromotion1, previousPromotion2, previousPromotion3; //Í¥ëÍ≥† ?ú†?òï, ?ù¥?†Ñ Í¥ëÍ≥† ?Ç¨Î°?
	private String text; //Í¥ëÍ≥† ?Ç¥?ö©
